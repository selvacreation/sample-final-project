...
const Header : React.FunctionComponent = ()=>{
    ...
    return(
        <div>
            ...
            <PrimaryButton id="on-btn" onClick={() => lightHandller("ON", "#on-btn")}>Turn ON </PrimaryButton>
            <PrimaryButton id="off-btn" onClick={()=> lightHandller("OFF", "#off-btn")}>Turn OFF </PrimaryButton>
            {
                showCallout.state && 
                <FocusTrapCallout
                  role="alertdialog"
