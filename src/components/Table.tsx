...
const Tables : React.FunctionComponent =  ()=>{
    ...
    const columns = [
        ...
        { key: 'column3', name: 'Sensor Value', fieldName: 'value', minWidth: 100, maxWidth: 200, isResizable: true },
        { key: 'column4', name: 'VALVE Status', fieldName: 'state', minWidth: 100, maxWidth: 200, isResizable: true },
      ];
